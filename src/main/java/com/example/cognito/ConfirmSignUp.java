...
public class ConfirmSignUp {
    ...
    public static void main(String[] args) {
        ...
        confirmSignUp(identityProviderClient, confirmationCode, username, clientId);
        identityProviderClient.close();
    }

    public static void confirmSignUp(CognitoIdentityProviderClient identityProviderClient, String confirmationCode, String username, String clientId) {
