...
//                        .build();
        ...
        static {
                ...
                CreateUserPoolClientRequest adminClientRequest = CreateUserPoolClientRequest.builder()
                                ...
                                .generateSecret(true)
                                .build();
                CreateUserPoolClientResponse adminClientResponse = cognitoClient
                                .createUserPoolClient(adminClientRequest);
        ...
        public static void main(String[] args) {
                ...
                AdminInitiateAuthResponse authResponse = new AdminAuthDemo(cognitoClient, COGNITO_POOL_ID,
                                COGNITO_ADMIN_CLIENT_ID, COGNITO_ADMIN_CLIENT_SECRET)
                ...
                AssociateSoftwareTokenResponse associateResponse = new SoftwareTokenMFADemo(cognitoClient)
                ...
                VerifySoftwareTokenResponse verifyResponse = new SoftwareTokenMFADemo(cognitoClient)
                                .verifySoftwareToken(session, code);

                // 3. Respond to an auth challenge [MFA_SETUP].
                session = verifyResponse.session();
                AdminRespondToAuthChallengeResponse challengeResponse = new AdminAuthDemo(cognitoClient,
                                COGNITO_POOL_ID, COGNITO_ADMIN_CLIENT_ID, COGNITO_ADMIN_CLIENT_SECRET)
                ...
                // 5. User SRP auth.
                RespondToAuthChallengeResponse userSrpResponse = new UserAuthDemo(cognitoClient, COGNITO_POOL_ID,
                ...
                // 6. Device SRP Auth.
                RespondToAuthChallengeResponse deviceSrpResponse = new DeviceAuthDemo(cognitoClient,
                                COGNITO_USER_CLIENT_ID)
                                .deviceSrpAuth(COGNITO_USERNAME, deviceGroupKey, deviceKey, devicePassword);
